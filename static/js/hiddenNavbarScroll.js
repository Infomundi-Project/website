document.addEventListener("DOMContentLoaded", function() {
    let lastScrollTop = 0;
    const navbar = document.getElementById('mainNavbar'); // Select the navbar by ID
    var commentsReturnButton = document.getElementById('commentsReturnButton');
    var commentsReturnButtonMobile = document.getElementById('commentsReturnButtonMobile');

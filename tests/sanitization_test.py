...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "This is a test \"string\" with 'quotes'.",
        ),  # HTML entities in a complex string
        (
            "This is a normal string.",
            "This is a normal string.",
        ),  # Already decoded string remains unchanged
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "Some text <unknown>with tag</unknown>",
            "Some text with tag",
        ),  # Stripped unknown tag
        (
            "<style>body { color: red; }</style> Styled text",
            "body { color: red; } Styled text",
        ),  # Removed style
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "https://example.com/?query=test#fragment",
            True,
        ),  # Valid with query and fragment
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "<div><p>Nested</div>",
            "<div><p>Nested</p></div>",
        ),  # Mixed well-formed and unclosed tags
